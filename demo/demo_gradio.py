...
# ==================== Configuration ====================
DEFAULT_CONFIG = {
    'ip': os.environ.get("BACKEND_HOST", "127.0.0.1"),
    'port_vllm': int(os.environ.get("BACKEND_PORT", 8000)),
...
def create_gradio_interface():
    ...
    with gr.Blocks(theme=gr.themes.Default(), css=css, title='dots.ocr') as demo:
